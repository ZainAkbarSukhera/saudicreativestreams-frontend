    ...
    <div className="workshop-card border-2 border-gray-300 rounded-lg flex relative p-4">
      <div className="w-full pr-6">
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="font-montserrat-regular">{date}</span>
        </div>
        <div className="flex items-center mb-2">
          <FaMapMarkerAlt className="mr-2 text-madder-lake" />
          <span className="font-montserrat-regular">{location}</span>
        </div>
        <div className="flex items-center mb-2">
          <FaUserAlt className="mr-2 text-madder-lake" />
          <span className="font-montserrat-regular">{instructor}</span>
        </div>
        <div className="flex items-center mb-2">
          <FaClock className="mr-2 text-madder-lake" />
          <span className="font-montserrat-regular">{duration}</span>
        </div>
