  ...
  return (
    <div className="container mx-auto">
     ...
     <div className='border-t border-black'>
       {/* Overview Section */}
       <div className="mb-8">
        <span className="text-lg font-montserrat-bold  mb-4">Overview:</span>
      ...
      <div className="mb-8">
        <h2 className="text-lg font-semibold mb-4">Bid Requirements</h2>
      ...
      <div className="mb-8">
        <h2 className="text-lg font-semibold mb-4">Prizes and Compensation</h2>
        <ul className="text-gray-700 space-y-2">
