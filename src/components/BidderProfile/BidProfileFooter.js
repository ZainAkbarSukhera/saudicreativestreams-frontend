  ...
  return (
    <footer className="bg-white py-8">
      ...
      <div className="container mx-auto ">
        <h2 className="text-lg font-semibold text-yankees-blue uppercase mb-4">View Similar Projects</h2>
        {/* Horizontal Line */}
      ...
      <div className="container mx-auto flex justify-center space-x-8">
        {projects.map((project, index) => (
          <div key={index} className="text-center">
            ...
            />
            <p className="text-yankees-blue text-sm font-semibold">{project.name}</p>
          </div>
        ))}
      </div>
    </footer>
