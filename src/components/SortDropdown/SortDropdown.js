...
const SortDropdown = ({ options, selectedOption, onOptionChange }) => {
  return (
    <div>
      ...
      <select
        className="px-4 py-2 border-black rounded-md text-yankees-blue font-montserrat-regular focus:outline-none focus:ring-2 focus:gray-800 focus:border-transparent"
