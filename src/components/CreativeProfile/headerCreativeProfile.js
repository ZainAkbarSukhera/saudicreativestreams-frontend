  ...
  return (
    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mx-4">
      ...
      <div className="flex flex-grow justify-start items-start ml-16 space-x-4 mt-4 lg:mt-0">
        ...
        <div className="flex items-center">
          <a href="https://www.instagram.com/theqandeel" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline mr-4">
            <FontAwesomeIcon icon={faInstagram} className="mr-1" />@theqandeel
          </a>
          <a href="https://www.linkedin.com/in/theqandeel" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
      ...
      {/* Right Section: Stats */}
      <div className="flex  flex-col items-start  mt-4 mr-8 lg:mt-0">
