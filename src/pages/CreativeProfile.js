...
const CreativeProfileComponent =()=>{
  ...
  return(
    <div className="min-h-screen flex flex-col">
      ...
      <div className="mt-36">
      <HeaderCreativeProfile initiativeName={bidderDetails.initiativeName} host={bidderDetails.host} pageViews={bidderDetails.pageViews}bidsSubmitted={bidderDetails.bidsSubmitted} daysRemaining={bidderDetails.daysRemaining} />
      </div>
